...
import { EsplLoginModalComponent } from './login-modal.component';
...
describe('Component: Login Modal', () => {
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EsplLoginModalComponent);
  ...
  it('should create the component', async(inject([], () => {
    fixture.whenStable().then(() => {
      ...
      expect(element.querySelector('espl-modal-content')).not.toBeNull();
      expect(element.querySelector('h1').innerText).toEqual('Login');
      expect(element.querySelector('espl-login-form')).not.toBeNull();
