...
interface IOBActions {
    ...
    INIT_FAILED: string;
    GET_LIST: string;
    GET_LIST_BY_OFFICER:string;
    GET_LIST_SUCCESS_BY_OFFICER: string;
...
export const OB_ACTIONS: IOBActions = {
    ...
    GET_LIST_BY_OFFICER: `${CONTEXT}GET_LIST_BY_OFFICER`,
    GET_LIST_SUCCESS: `${CONTEXT}GET_LIST_SUCCESS`,
    GET_LIST_SUCCESS_BY_OFFICER:`${CONTEXT}GET_LIST_SUCCESS_BY_OFFICER`,
